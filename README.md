...
These data were analysed in SPSS. Full details of the meta-analysis procedure can be found in our publication, cited below.
...
This data has been released under [GNU General Public License (v3)](https://www.gnu.org/licenses/gpl-3.0.en.html) license to promote open source app development and sharing of innovation within the research community. Simply, use freely but make accessible to others.
